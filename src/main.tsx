...
import ProductOpsCenter from './ProductOpsCenter';
...
migrateWorkspace();
function Product(){const [view,setView]=useState<'client'|'flow'|'automation'|'tools'|'platform'|'ops'>('client');const [importOpen,setImportOpen]=useState(false);const [importFile,setImportFile]=useState<File|null>(null);
